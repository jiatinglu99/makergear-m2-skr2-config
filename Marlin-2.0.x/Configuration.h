...
#define STRING_CONFIG_H_AUTHOR "(Terry Lu, www.terrylu.cloud)" // Who made the changes.
...
#define EXTRUDE_MAXLENGTH 480 // (X_MAX_LENGTH+Y_MAX_LENGTH)=220+4+255+0=479
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 34.2, 0, 0 }
